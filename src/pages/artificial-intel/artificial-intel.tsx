...
import artificialBg from "../../assets/svg/ai-bg.svg";
import artificialBanner from "../../assets/svg/ai-banner.svg";
        ...
        <div className="bg-[rgba(0,0,0,0.6)] w-full h-full z-10 absolute flex md:justify-end sm:justify-center items-center md:pr-[130px]">
          <div className="z-10 absolute flex h-full md:text-right flex-col md:items-end md:justify-end sm:justify-center sm:items-start md:w-[50%] sm:w-full sm:px-4">
            ...
            <motion.p
              ...
              animate="animate"
            >
              Our team is knowledgeable about information examination and AI
              state-of-the-art procedures. We additionally consolidate our area
              information in funds, medical care, flying, diversion, security,
              IoT, and versatility into these arrangements. Our information
              examination and AI specialists are knowledgeable about the
              significant business principles, which permits us to assemble any
              acknowledgment, investigator, or prescient framework.
            </motion.p>
          </div>
        </div>
        <motion.div
