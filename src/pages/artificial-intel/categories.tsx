    ...
    >
      <div className="md:w-[65%] flex flex-col justify-center md:items-center sm:items-start dark:text-white md:text-center pb-14">
        <motion.h2
          ...
          animate="animate"
        >
          Our Artificial Intelligence Categories
        </motion.h2>
        <motion.p
          ...
          animate="animate"
        >
          Our organization has immense experience in portrayal on the worldwide
          market and global action. It doesn't make any difference where you
          are, what your solicitation is, what your assumptions are, and what
          the intricacy of your undertaking is — our specialists will adapt to
          any project and play out the work at the most significant level
          regardless.
        </motion.p>
      </div>
