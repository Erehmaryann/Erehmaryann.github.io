    ...
    >
      <div className="md:w-[65%] flex flex-col justify-center md:items-center sm:items-start dark:text-white md:text-center pb-14">
        <motion.h2
          ...
          animate="animate"
        >
          Our Custom Software Development Categories
        </motion.h2>
        <motion.p
          ...
          animate="animate"
        >
          From thought to advancement to help and support, our improvement
          interaction is pointed toward conveying work of excellent effects.
        </motion.p>
      </div>
